<template>
  <div class="container">
    ...
    <div class="row mb-3">
      <div class="col-12">
        <router-link to="/customers" type="button" class="btn btn-success m-1">Manage customers</router-link>
        <router-link to="/employees" type="button" class="btn btn-success m-1">Manage employees</router-link>
        <router-link to="/accounts" type="button" class="btn btn-success m-1">Manage accounts</router-link>
        <router-link to="/transactions" type="button" class="btn btn-success m-1">Manage transactions</router-link>
      </div>
    </div>
    <ul class="list-group">
      <li
